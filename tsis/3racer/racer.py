...
def play_game(screen, username):
    ...
    # load assets
    image_background = pygame.image.load('3racer/assets/AnimatedStreet.png')
    image_player     = pygame.image.load('3racer/assets/Player.png')
    image_enemy      = pygame.image.load('3racer/assets/Enemy.png')
    coin_image       = pygame.image.load('3racer/assets/dollar.png').convert_alpha()

    if settings.get("sound", True):
        pygame.mixer.music.load('3racer/assets/background.wav')
        pygame.mixer.music.play(-1)
    else:
        pygame.mixer.music.stop()
    sound_crash = pygame.mixer.Sound('3racer/assets/crash.wav')
