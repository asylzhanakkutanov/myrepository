...
def text_input_screen(screen, prompt):
    ...
    while True:
        ...
        # Render typed text with cursor indicator
...
def main_menu(screen):
    ...
    while True:
        ...
        # Draw all buttons and highlight if mouse is over them
...
def leaderboard_screen(screen):
    ...
    while True:
        ...
        # Draw title "TOP 10" at the top center
